...
export class STAStarshipSheet extends ActorSheet {
  ...
  get template() {
    ...
    if (!isNewerVersion(versionInfo,"0.8.-1")) return "systems/sta-ng/templates/actors/starship-sheet-legacy.html";
    return `systems/sta-ng/templates/actors/starship-sheet.html`;
  }
